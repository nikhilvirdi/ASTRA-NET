...
ASTRA-NET tells you what's actually happening in space right now, above your exact location — the ISS passing overhead, a thousand real satellites tracing their true positions, an aurora that might reach your latitude tonight, an asteroid making its closest approach, the real planets and stars visible from where you're standing.
...
Explore renders the sky as it actually is right now — not just the Sun, Moon, and planets, but over a thousand real satellites, computed live from their actual orbital elements: Starlink, the ISS, GPS, weather satellites, tracked debris. Constellation lines connect real star positions, redrawn as the sky turns. On a phone, you can point it at the sky and the view follows where you're actually looking.
...
| [CelesTrak](https://celestrak.org/)                                                                  | Live satellite orbital elements — Starlink, GPS, weather, geostationary, debris, and more | Keyless. [Space-Track.org](https://www.space-track.org/) is used as a fallback source when CelesTrak is unreachable |
| [Open-Meteo](https://open-meteo.com/)                                                                | Real-time and forecasted cloud cover and visibility                                       | Keyless                                                                                                             |
| NASA Black Marble                                                                                    | Sky quality / light pollution estimate                                                    | Public-domain night-lights composite, self-hosted                                                                   |
| HYG Database                                                                                         | The real star catalog rendered in Explore                                                 | Static dataset, self-hosted                                                                                         |
| [d3-celestial](https://github.com/ofrohn/d3-celestial)                                               | Constellation line figures                                                                | BSD 3-Clause licensed, self-hosted                                                                                  |
