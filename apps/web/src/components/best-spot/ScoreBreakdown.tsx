    ...
    <div className="flex flex-col gap-2 font-mono text-xs text-sky-200 bg-sky-950/60 p-3 border border-sky-800/40">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="w-16 uppercase text-caption text-sky-400 font-sans">CLARITY</span>
          {clarityAvailable && clarity.available ? (
            <RenderTickBar factor={clarity.factor} colorClass="text-brass-300" />
          ) : (
            <span className="text-sky-600 tracking-tight">▯▯▯▯▯▯▯▯</span>
          )}
        </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="w-16 uppercase text-caption text-sky-400 font-sans">DARKNESS</span>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="w-16 uppercase text-caption text-sky-400 font-sans">TRAVEL</span>
      ...
      {aurora && (
        <div className="flex items-center justify-between pt-1 border-t border-sky-800/40 text-emerald-400">
          <div className="flex items-center gap-3">
            <span className="w-16 uppercase text-caption text-emerald-400 font-sans">AURORA</span>
