...
// CelesTrak TLE (FORMAT=tle) schema/parsing moved to `../../lib/tle.js` —
// the same fixed-column NORAD format Space-Track's client also consumes,
// so it's shared rather than duplicated per client. Re-exported below for
// backward compatibility with existing imports of this module.
export {
  TleRecordSchema as CelestrakTleRecordSchema,
  TleRecordsSchema as CelestrakTleRecordsSchema,
} from '../../lib/tle.js';
export type { TleRecordParsed as CelestrakTleRecordParsed } from '../../lib/tle.js';
