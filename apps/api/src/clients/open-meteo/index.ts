export { fetchOpenMeteo, fetchOpenMeteoBatch } from './open-meteo.client.js';
export type { FetchOpenMeteoParams, FetchOpenMeteoBatchParams } from './open-meteo.client.js';
